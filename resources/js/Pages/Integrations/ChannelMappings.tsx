...
export default function ChannelMappings({ workspace_mappings, global_mappings, unrecognized, is_recomputing }: Props) {
    ...
    const tabs = [
        ...
        { label: 'Channel Mappings',  value: 'channel-mappings',  href: w('/integrations/channel-mappings'),  active: true },
    ];

    const handleAdd = (data: { utm_source_pattern: string; utm_medium_pattern: string; channel_name: string; channel_type: string }) => {
        setProcessing(true);
        router.post(w('/integrations/channel-mappings'), data, {
    ...
    const handleDelete = (id: number) => {
        ...
        setDeletingId(id);
        router.delete(w(`/integrations/channel-mappings/${id}`), {
    ...
    const handleImportDefaults = () => {
        ...
        router.post(w('/integrations/channel-mappings/import-defaults'), {}, {});
    };
