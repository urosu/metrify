...
/**
 * Naming Convention audit — renders at /tools/naming-convention.
 *
 * Shows the fixed pipe-delimited template, parse-status buckets, and a 30-day
 ...
 *
 * Pattern: Northbeam naming-convention enforcement — coverage % + bucket audit.
 *
 * Reads: campaigns, ad_accounts, ad_insights.
 * Writes: nothing.
 * Called by: GET /{workspace:slug}/tools/naming-convention
 *
 * @see docs/planning/backend.md §6
 * @see docs/competitors/_research_tools_utilities.md §3
 */
class NamingConventionController extends Controller
{
    public function __invoke(Request $request): Response
    {
        ...
        return Inertia::render('Tools/NamingConvention', [
            'buckets' => [
                'clean'   => $clean,
                'partial' => $partial,
                'minimal' => $minimal,
