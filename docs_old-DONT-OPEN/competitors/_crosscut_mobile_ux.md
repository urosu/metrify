...
1. `/dashboard` — top KPI cards stack vertically; source-badge row collapses to a single "see sources" chip that expands to show Real · Store · Facebook · Google · GSC · GA4.
