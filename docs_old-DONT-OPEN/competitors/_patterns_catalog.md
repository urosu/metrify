...
- **What:** Under the headline number, a horizontal strip of six per-source badges in canonical order (Real · Store · Facebook · Google · GSC · GA4) with each showing their own count; "Real" (gold lightbulb) is leftmost and the default active lens.
