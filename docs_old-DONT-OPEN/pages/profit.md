...
| GA4 / GSC | no | Not directly relevant to profit; source badges shown as greyed/unavailable on MetricCards. GA4 session data informs CVR-related context but profit calculations do not use GA4 directly. | — |
